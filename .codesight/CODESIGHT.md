...
> 4 routes | 0 models | 0 components | 25 lib files | 5 env vars | 1 middleware | 84 import links
> **Token savings:** this file is ~1,800 tokens. Without it, AI exploration would cost ~16,300 tokens. **Saves ~14,500 tokens per conversation.**
